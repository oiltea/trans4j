...
public class CaffeineCachingTranslateProvider implements TranslateProvider {

  private final TranslateProvider delegate;
  private final TranslateCache translateCache;

  public CaffeineCachingTranslateProvider(
      TranslateProvider delegate, TranslateCache translateCache) {
